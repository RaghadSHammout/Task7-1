...
export default function Hero() {
  return (
    <section className='hero pt-5 '>
      <img src={wavy} className='position-absolute wavy1' alt="" />
      <div className=' container  h-100 hero-container row'>
        <div className='col-lg-6 col-md-6 col-sm-12 hero-left'>
          <div className='hero-left-top'>
            <div className='border text-center Heartbeat my-2'><p><TbActivityHeartbeat />
            Everything You Need To Create A Website</p></div>
            <div className='hero-text'>
              <h1 className='my-2'>Business Innovation With IT Services Expertise</h1>
            </div>
