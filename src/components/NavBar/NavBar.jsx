...
export default function Navbar() {
    ...
    return (
        <nav
            className={`position-relativ navbar navbar-expand-lg navbar-light ${isSpecialPage ? 'special-navbar' : 'CustomNav'}`}
        ...
        >
            <div className="container d-flex align-items-center ">
                ...
                <div className="d-flex align-items-center">
                    {isSpecialPage && (
                        <img src={plane} alt="Image" height="30" className="me-2" />
                    )}
                    <Link className="navbar-brand" to="/">
                        <img src={logo} className='logo-extech' alt="Logo" height="30" />
                    </Link>
                </div>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    ...
                    {isHomePage && (
                        <Link to="/" className="btn cart me-2">
                            <FaShoppingCart />
                        </Link>
                    )}
