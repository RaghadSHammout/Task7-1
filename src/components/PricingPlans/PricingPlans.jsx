    ...
    return (
        <div className="container my-5 text-center position-relative">
            <div className=" mb-4 w-100 services-titlte ">
                <p className="text-primary fw-bold"> <IoIosArrowRoundBack/> OUR PRICING <IoIosArrowRoundForward/></p>
      ...
      <img src={diamond} className='diamond position-absolute' alt="diamond" />
            <div className=" d-flex justify-content-center align-items-center flex-wrap mb-4">
                <div className="border plan-btn p-2 " role="group">
                    <button type="button" className="btn border Monthly-btn">Monthly</button>
                    <button type="button" className="btn border-0">Yearly</button>
                </div>
