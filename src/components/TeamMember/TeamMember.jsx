    ...
    return (
        <section className='TeamMember container p-5'>
            ...
            <div className=" mb-4 services-titlte ">
                <p className="text-primary fw-bold"> <IoIosArrowRoundBack /> TEAM MEMBERS <IoIosArrowRoundForward /></p>
                <h2 className="fw-bold">Our Dedicated Team Member</h2>
            </div>
            <div className="d-flex justify-content-end mb-3 ">
                    <button className="btn bg-primary member-btn ">
                        All Members<IoIosArrowRoundForward/>
                    </button>
            ...
            <div className='envato '>
                <div className='envato-title'>
                    <div className='line w-25'></div><h3>1k + Brands Trust Us</h3><div className='line w-25'></div>
                </div>
            </div>
            <div className='container specilaize'>
        <ul className='flex-list-brand '>
            <li><img src={envato2} alt="asterisk" /></li>
            <li><img src={envato2} alt="asterisk" /></li>
            <li><img src={envato} alt="asterisk" className='blue-envato' /></li>
            <li><img src={envato2} alt="asterisk" /></li>
            <li><img src={envato2} alt="asterisk" /></li>
        </ul>
    </div>
